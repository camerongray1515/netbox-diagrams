 ...
 */
EditorUi.prototype.footerHeight = window.EDITOR_STOP_BOTTOM;
...
EditorUi.prototype.refresh = function(sizeDidChange)
{
	...
	var tmp = window.EDITOR_START_TOP;
	...
	if (this.toolbar != null)
	{
		this.toolbarContainer.style.top = window.EDITOR_START_TOP + this.menubarHeight + 'px';
...
EditorUi.prototype.createDivs = function()
{
	...
	this.menubarContainer.style.top = window.EDITOR_START_TOP + 'px';
